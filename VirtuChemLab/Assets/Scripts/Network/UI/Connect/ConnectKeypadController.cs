...
namespace Network.UI.Connect
{
    ...
    public class ConnectKeypadController : MonoBehaviour
    {
        ...
        public string defaultUsername = "Peter";
        ...
        [SerializeField]
        public InputField ipAddressInput, portInput, usernameInput;
        ...
        public void Host()
        {
            NetworkLobbyManager.Singleton.Host(usernameInput.text);
        }
        ...
        public void Connect()
        {
            ...
            NetworkLobbyManager.Singleton.Connect(usernameInput.text, ip, port);
        }
