...
public class ObjectCollisionIgnoreForce : MonoBehaviour
{
    ...
    void OnCollisionEnter(Collision coll)
    {
        ...
        if ((coll.gameObject.CompareTag("PlasticContainer") || coll.gameObject.CompareTag("PlasticObject")) && retriggerWaitTime == 0.0f)
        {
