...
public class SoundsGlassErlenmeyerFlask : MonoBehaviour
{
    ...
    //tells if a digital ph indicator is inside
    [HideInInspector]
    ...
    void OnCollisionEnter(Collision coll)
    {
        ...
        if ((coll.gameObject.CompareTag("PlasticContainer") || coll.gameObject.CompareTag("PlasticObject")) && retriggerWaitTime == 0.0f && !isInside)
        {
